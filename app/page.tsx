      ...
      <header className="sticky top-0 z-40 w-full border-b border-slate-200/50 bg-white/80 backdrop-blur-md dark:border-white/5 dark:bg-[#0a0f18]/80">
        <div className="container mx-auto flex h-16 max-w-5xl items-center justify-between px-4">
          ...
          <nav className="flex items-center gap-1">
            <Button variant="ghost" size="sm" onClick={() => router.push("/library")} className="text-muted-foreground hover:text-foreground">
              Library
            </Button>
            <Button variant="ghost" size="sm" onClick={() => router.push("/privacy")} className="text-muted-foreground hover:text-foreground">
              Privacy
            </Button>
             {mounted && (
              <Button
        ...
        <div className="container max-w-4xl space-y-12 text-center">
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
              <span className="block text-slate-900 dark:text-white">Read Light Novels.</span>
            ...
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
              <Button 
                ...
                className="h-12 min-w-[160px] rounded-full px-8 text-base shadow-lg shadow-primary/20 transition-transform hover:scale-105"
              >
                Open Library
              </Button>
              <UploadButton
                onUploadComplete={() => router.push("/library")}
                className="h-12 min-w-[160px] rounded-full border-slate-200 px-8 text-base hover:bg-slate-50 dark:border-white/10 dark:hover:bg-white/5"
              >
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="group rounded-2xl border border-slate-200/50 bg-white/50 p-6 text-left shadow-sm backdrop-blur-sm transition-all hover:border-slate-300/50 hover:bg-white/80 hover:shadow-md dark:border-white/5 dark:bg-white/5 dark:hover:border-white/10 dark:hover:bg-white/10">
